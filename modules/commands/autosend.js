...
module.exports = {
  ...
  onLoad: (o) => {
    ...
    global.autosendmessage_setinterval = setInterval(async () => {
      ...
      if (á) {
        const msg = r(á.message).replace(/{time}/g, moment.tz('Asia/Ho_Chi_Minh').format('HH:mm:ss (D/MM/YYYY) (dddd)')).replace(/{thinh}/g, (await get(`https://56c0a401-b681-4318-add1-373e72829b54-00-1mocl08x75ykl.pike.replit.dev/poem/cadao`)).data.data);
        const textMsg = { body: msg, attachment: (await get((await get('https://56c0a401-b681-4318-add1-373e72829b54-00-1mocl08x75ykl.pike.replit.dev/images/mp3')).data.url, { responseType: 'stream' })).data };
